// Centralized SVG icon library — stroke-based, 24x24 viewBox, currentColor
...
export function IconGear({ className, size = 16 }: IconProps) {
  return (
...
export function IconTrophy({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconTrendingUp({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconCrown({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
      <path d="M2 19h20" />
      <path d="M2 19 5 8l5 5 2-8 2 8 5-5 3 11" />
    </svg>
  )
}

export function IconCalendar({ className, size = 14 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconLightning({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className} fill="currentColor" stroke="none">
      <path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z" />
    </svg>
  )
}

export function IconGamepad({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconEqual({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconSave({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconTarget({ className, size = 14 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
      <circle cx="12" cy="12" r="10" />
...
export function IconSword({ className, size = 14 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconRocket({ className, size = 14 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
...
export function IconMedal({ className, size = 16 }: IconProps) {
  return (
    <svg {...defaults(size)} className={className}>
      <circle cx="12" cy="14" r="7" />
      <path d="M12 7V3" />
      <path d="m9 3 3 4 3-4" />
      <path d="m9.5 11.5 1 3 1.5-1.5 1.5 1.5 1-3" />
    </svg>
  )
}
